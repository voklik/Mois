...
const DestinationCreate = () => {
    ...
    const handleSubmit = (event) => {
        ...
        fetch("http://localhost:8081/rest/api/destinations/create", requestOptions)
    ...
    const getDestinationTypes = () => {
        ...
        fetch("http://localhost:8081/rest/api/destination-types/", requestOptions)
            .then(result => {
                result.json()
                    .then(data =>
                                        ...
                                        />
                                        {
                                            destinationTypesSelect.map(
                                                destinationType => {
                                                    return (
                                                        <MenuItem
                                                            value={destinationType.id}>{destinationType.name}</MenuItem>
                                                    )
                                                }
                                            )
                                        }
